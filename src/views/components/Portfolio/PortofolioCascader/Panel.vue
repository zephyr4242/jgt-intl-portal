<template>
  <div :class="[
    ...
    <PortofolioCascaderMenu ref="menu" v-for="(menu, index) in menus" :index="index" :key="index" :nodes="menu" :defaultWidth="defaultWidth" />
  </div>
</template>

<script>
import PortofolioCascaderMenu from './Menu'
...
export default {
  name: 'PortofolioCascaderPanel',

  components: {
    PortofolioCascaderMenu
  },
