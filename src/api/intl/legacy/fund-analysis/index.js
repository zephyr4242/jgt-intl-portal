...
export const queryPerformanceAnalysis = notImpl('fund-analysis/queryPerformanceAnalysis')
export const queryYieldRiskAnalysis = notImpl('fund-analysis/queryYieldRiskAnalysis')
