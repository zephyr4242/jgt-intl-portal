...
var PDFViewerApplication = {
          ...
          switch (_context.prev = _context.next) {
            ...
            case 8:
              if (this.isViewerEmbedded && _app_options.AppOptions.get('externalLinkTarget') === _pdfjsLib.LinkTarget.NONE) {
                // 【ID1008937】【客户端2.0】帮助中心中部分文件包含网址跳转，客户端点击会白屏
                // https://www.tapd.cn/38411657/bugtrace/bugs/view?bug_id=1138411657001008937
          ...
          switch (_context7.prev = _context7.next) {
            ...
            case 3:
              ...
              return _context7.abrupt('return', loadingTask.promise.then(function (pdfDocument) {
                ...
                if (parent && parent.document.getElementById('jfPdfIframe') && parent.document.getElementById('jfPdfIframe').contentDocument === document) {
                  window.parent.jfPdfIframeErrored();
                }
  ...
  download: function download() {
    ...
    var idx = window.location.href.indexOf('&fileName=')
    if(idx !== -1){
      filename = decodeURIComponent(window.location.href.substring(idx + 10))
    }
...
var ProgressBar = function () {
  ...
  _createClass(ProgressBar, [{
    ...
    value: function _updateBar() {
      ...
      if (progressSize === 100) {
        if (parent && parent.document.getElementById('jfPdfIframe') && parent.document.getElementById('jfPdfIframe').contentDocument === document) {
          window.parent.jfPdfIframeLoaded();
        }
      }
